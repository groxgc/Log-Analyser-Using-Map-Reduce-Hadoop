...
* @author g_chawla
*/
public class DDOS_INV_RESULT extends javax.swing.JFrame {

   /**
    * Creates new form DDOS_INV_RESULT
    */
   public DDOS_INV_RESULT() {
       initComponents();
       //Flag    
...
//Flag
   ...
   private void initComponents() {
       ...
       jLabel1.setText("DISTRIBUTED DENIED CLIENT REQUEST");
   ...
   public static void main(String args[]) {
       ...
       try {
           ...
           java.util.logging.Logger.getLogger(DDOS_INV_RESULT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       java.awt.EventQueue.invokeLater(new Runnable() {
           public void run() {
               new DDOS_INV_RESULT().setVisible(true);
           }
       });
   }
